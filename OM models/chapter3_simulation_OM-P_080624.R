...
#Model that evaluate changes in occupancy probabilities
...
{ #start code to simulate population
  ...
  #est_occ$stock<-ifelse(occ$stock==1,"Chesapeake Bay","Atlantic Coast")
  est_occ<-subset(est_occ, param=="obs")
  #head(prior)
  #prior$LCI<-exp(prior$prob-1.96*prior$logsd)
  #prior$UCI<-exp(prior$prob+1.96*prior$logsd)
  #prior$timestep<-ifelse(prior$timestep==1,"Jan-Jun","Jul-Dec")
  ...
  #   for (a in 1:lage) {
  #     for(ts in 1:3){
  #       if(occ[cb,ac,ts,y,a]>occ[cb,ac,4,y,a]){
  #         occ[cb,ac,ts,y,a]<-occ[cb,ac,4,y,a]
  #     }
  #     }
  #   }
  # }
  ...
  occ_table<- melt(occ)
  #head(occ_table)
  colnames(occ_table)<-c("Stock","Region","Time-Step","Year","Age","Occ")
  #write.csv(occ_table,"C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/Final_output/occupancy_om3_25.csv")
  ...
  # 
  true_F_spr_faa<--99 #not calculating refrence poitns but leaving opption in the dataset
  true_spr<-c(-99,-99)
...

{
  ...
  setwd("C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/movement_om3")
...
output_faa2_om3<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/movement_om3/faamodel2/sim_results.txt',header=F, sep="")
output_se4_om3<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/movement_om3/semodel4/sim_results.txt',header=F, sep="")
output_se6_om3<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/movement_om3/semodel6/sim_results.txt',header=F, sep="")



output_faa2_om3$model<-"FAA"
colnames(output_faa2_om3) <- c("simnum","year","F8est","Fre","estNtot","Nre",'estb','Bre','estssb','SSBre','estF40','F40RE', 'estR','Rre' ,"obj","model")

output_se4_om3$model<-"SE" #SE4 is spatially explicit with aging error
colnames(output_se4_om3) <- c("simnum","year","F8est","Fre","estNtot","Nre","estNtotCB","NreCB","estNtotAC","NreAC",'estb','Bre','estssb','SSBre','estF40','F40RE', 'estF40_cb','F40RE_cb','estF40_ac','F40RE_ac','estR','Rre' ,'estRcb','Rre_cb','estRac','Rre_ac',"obj","model")

output_se6_om3$model<-"SE-S" #SE5 is spatially explicit with stock in data 
colnames(output_se6_om3) <- c("simnum","year","F8est","Fre","estNtot","Nre","estNtotCB","NreCB","estNtotAC","NreAC",'estb','Bre','estssb','SSBre','estF40','F40RE', 'estF40_cb','F40RE_cb','estF40_ac','F40RE_ac','estR','Rre' ,'estRcb','Rre_cb','estRac','Rre_ac',"obj","model")
...
output_om3<-bind_rows(output_faa2_om3,output_se4_om3,output_se6_om3)
output_om3$OM<-"OM3"


output_om3<-subset(output_om3,obj<0.01)
#range(output$obj)

#write.csv(output_om3,"C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/Final_output/output_om3_25.csv")
write.csv(output_om3,"C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/Final_output/output_om3_50.csv")
...
print(c("FAA",length(unique(output$simnum[output$model=="FAA2"]))))
print(c("SE", length(unique(output$simnum[output$model=="SE4"]))))
print(c("SE-S", length(unique(output$simnum[output$model=="SE5"]))))

coln<-c("simnum","model", "Nre","year")
Noutput<-output_om3[, (colnames(output_om3) %in% coln)]
...
# plot(occ[1,2,4,30,],pch=16,ylim=c(0,1))
# points(occ[1,2,5,30,],pch=16,col="red")
# points(occ[1,2,6,30,],pch=16,col="orange")
...
SSBoutput<-output_om3[, (colnames(output_om3) %in% colssb)]
...
Boutput<-output_om3[, (colnames(output_om3) %in% colbio)]
...
Foutput<-output_om3[, (colnames(output_om3) %in% colf)]
ggplot()+
...
terminal<-output_om3[, (colnames(output_om3) %in% colterm)]
...
estfage_faa2<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/movement_om3/faamodel2/sim_F_results.txt',header=F, sep="")
estfage_se4<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/movement_om3/semodel4/sim_F_results.txt',header=F, sep="")
estfage_se5<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/movement_om3/semodel6/sim_F_results.txt',header=F, sep="")
...
output_f$operating<-"OM3"

#write.csv(output_f,"C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/Final_output/foutput_om3_25.csv")
write.csv(output_f,"C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/Final_output/foutput_om3_50.csv")
