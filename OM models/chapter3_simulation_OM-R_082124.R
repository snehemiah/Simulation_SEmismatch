...
# Operating model 4- change in recruitment
...
{ #start code to simulate population
  ...
  rtable_table<- melt(log_R_year)
  #head(occ_table)
  colnames(rtable_table)<-c("Stock","Year","Log_R")
  write.csv(rtable_table,"C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/Final_output/recruit_om4.csv")
  ...
  #write.csv(recruit,"C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/Final_output/obsrecruit_om4_dev.csv")
...

{
  ...
  setwd("C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/R_om4")
...
output_faa2_om4<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/R_om4/faamodel2/sim_results.txt',header=F, sep="")
output_se4_om4<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/R_om4/semodel4/sim_results.txt',header=F, sep="")
output_se5_om4<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/R_om4/semodel6/sim_results.txt',header=F, sep="")



output_faa2_om4$model<-"FAA"
colnames(output_faa2_om4) <- c("simnum","year","F8est","Fre","estNtot","Nre",'estb','Bre','estssb','SSBre','estF40','F40RE', 'estR','Rre' ,"obj","model")

output_se4_om4$model<-"SE" #SE4 is spatially explicit with aging error
colnames(output_se4_om4) <- c("simnum","year","F8est","Fre","estNtot","Nre","estNtotCB","NreCB","estNtotAC","NreAC",'estb','Bre','estssb','SSBre','estF40','F40RE', 'estF40_cb','F40RE_cb','estF40_ac','F40RE_ac','estR','Rre' ,'estRcb','Rre_cb','estRac','Rre_ac',"obj","model")

output_se5_om4$model<-"SE2" #SE5 is spatially explicit with stock in data 
colnames(output_se5_om4) <- c("simnum","year","F8est","Fre","estNtot","Nre","estNtotCB","NreCB","estNtotAC","NreAC",'estb','Bre','estssb','SSBre','estF40','F40RE', 'estF40_cb','F40RE_cb','estF40_ac','F40RE_ac','estR','Rre' ,'estRcb','Rre_cb','estRac','Rre_ac',"obj","model")
...
ggplot()+
  geom_boxplot(data=output_se4_om4, aes(x=(year),y=Nre,group=year))+
  ...
  geom_boxplot(data=output_se4_om4, aes(x=(year),y=Fre,group=year),col="orange")+
  geom_hline(yintercept=0,linetype="dashed",col="red")+
  #geom_line(data=Noutput,aes(x=year,y=Nre,col=as.factor(simnum)))+
...
output_om4<-bind_rows(output_faa2_om4,output_se4_om4,output_se5_om4)
output_om4$OM<-"Recruitment"
output_om4<-subset(output_om4,obj<0.01)

write.csv(output_om4,"C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/Final_output/output_om4.csv")
...
print(c("FAA",length(unique(output_om4$simnum[output_om4$model=="FAA"]))))
print(c("SE", length(unique(output_om4$simnum[output_om4$model=="SE"]))))
print(c("SE2", length(unique(output_om4$simnum[output_om4$model=="SE2"]))))

coln<-c("simnum","model", "Nre","year")
Noutput<-output_om4[, (colnames(output_om4) %in% coln)]
...
SSBoutput<-output_om4[, (colnames(output_om4) %in% colssb)]
...
Boutput<-output_om4[, (colnames(output_om4) %in% colbio)]
...
Foutput<-output_om4[, (colnames(output_om4) %in% colf)]
...
Routput<-output_om4[, (colnames(output_om4) %in% colR)]
...
terminal<-output_om4[, (colnames(output_om4) %in% colterm)]
...
estfage_faa2<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/R_om4/faamodel2/sim_F_results.txt',header=F, sep="")
estfage_se4<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/R_om4/semodel4/sim_F_results.txt',header=F, sep="")
estfage_se5<- read.csv('C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/R_om4/semodel6/sim_F_results.txt',header=F, sep="")
...
output_f$operating<-"OM4"
write.csv(output_f,"C:/Users/Anyone/Documents/PhD - UMCES/NCBO Project/Striped-Bass-SCAA/Rcode/Simulation/Chapter3/Final_output/foutput_om4.csv")
